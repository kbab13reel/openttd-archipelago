...
class OpenTTDWorld(World):
    ...
    def interpret_slot_data(cls, slot_data: dict[str, Any]) -> dict[str, Any]:
        ...
        result = {
            ...
            "train_tier_count": slot_data.get("train_tier_count", 5),
            "road_vehicle_tier_count": slot_data.get("road_vehicle_tier_count", 4),
            "aircraft_tier_count": slot_data.get("aircraft_tier_count", 4),
            "ship_tier_count": slot_data.get("ship_tier_count", 3),
            "enable_trams": slot_data.get("enable_trams", 0),
            "tram_tier_count": slot_data.get("tram_tier_count", 3),
            "vehicle_tier_distribution_mode": slot_data.get("vehicle_tier_distribution_mode", 0),
    ...
    def fill_slot_data(self) -> dict[str, Any]:
        ...
        return {
            ...
            "train_tier_count": self.options.train_tier_count.value,
            "road_vehicle_tier_count": self.options.road_vehicle_tier_count.value,
            "aircraft_tier_count": self.options.aircraft_tier_count.value,
            "ship_tier_count": self.options.ship_tier_count.value,
            "enable_trams": self.options.enable_trams.value,
            "tram_tier_count": self.options.tram_tier_count.value,
            "vehicle_tier_distribution_mode": self.options.vehicle_tier_distribution_mode.value,
